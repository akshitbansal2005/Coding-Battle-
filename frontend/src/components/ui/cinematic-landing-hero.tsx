...
export function CinematicHero({ 
  ...
  phoneHeaderTitle = "Today",
  phoneHeaderSubtitle = "Journey",
  phoneHeaderInitials = "JS",
  badge1Emoji = "🔥",
  badge1Text = "1 Year Streak",
  badge1Subtext = "Milestone unlocked",
  badge2Emoji = "🤝",
  badge2Text = "Sponsor Update",
  badge2Subtext = "Shared successfully",
  phoneWidgets,
  ctaButtons,
  className, 
  ...props 
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">{phoneHeaderTitle}</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">{phoneHeaderSubtitle}</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">{phoneHeaderInitials}</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30 shadow-inner">
                    <span className="text-base lg:text-xl drop-shadow-lg" aria-hidden="true">{badge1Emoji}</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">{badge1Text}</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">{badge1Subtext}</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner">
                    <span className="text-base lg:text-lg drop-shadow-lg" aria-hidden="true">{badge2Emoji}</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">{badge2Text}</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">{badge2Subtext}</p>
                  </div>
                </div>
